            ...
            <AwesomeButtonC137
                ...
                onPress = { () => {
                    ...
                    navigation.reset({
                        index: 0,
                        routes: [
                            { name: "narrative", params: { order: order, parsedPal: otherParsedPal, surveyData: {count: 1, name: userName, palcode: otherParsedPal, questionnaire: otherPalString, narratives:{}} }}
                        ]
                    });
                }}
            >
